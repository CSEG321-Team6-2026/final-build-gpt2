...
| 파일 | 구현 내용 |
|------|----------|
| `modules/attention.py` | Masked Multi-Head Self-Attention |
| `modules/gpt2_layer.py` | GPT-2 Transformer Layer |
| `models/gpt2.py` | Token + Positional Embedding |
| `optimizer.py` | Adam Optimizer `step()` |
