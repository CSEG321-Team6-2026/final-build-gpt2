...
if __name__ == "__main__":
  ...
  # IMDB Training
  print('Training Sentiment Classifier on IMDB...')
  imdb_config=SimpleNamespace(
    filepath='imdb-classifier.pt',
    lr=args.lr,
    ...
    dev='data/imdb-dev.csv',
    test='data/imdb-dev.csv',
    fine_tune_mode=args.fine_tune_mode,
    seed=args.seed,
    dev_out='predictions/' + args.fine_tune_mode + '-imdb-dev-out.csv',
    test_out='predictions/' + args.fine_tune_mode + '-imdb-test-out.csv'
  )

  train(imdb_config)

  print('Evaluating on IMDB Baseline...')
  test(imdb_config)